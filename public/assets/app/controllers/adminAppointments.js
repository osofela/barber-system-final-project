app.controller('adminController', function($rootScope,$scope,$http, API_URL,$compile, $timeout, uiCalendarConfig,$aside,$alert)
{
    ...
    $scope.reloadCalendar = function(userId)
    {
    ...
    $scope.getAppointments = function()
    {
        ...
        $http.get(API_URL + "users/" + $scope.loggedInUser.user_id + "/appointments")
            .success(function(response) {
