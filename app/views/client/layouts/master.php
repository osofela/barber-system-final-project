...
<head>
    ...
    <link href="../../../assets/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css" id="style_color"/>="stylesheet" type="text/css" id="style_color"/>
...
<div class="page-header navbar navbar-fixed-top">
    <!-- BEGIN HEADER INNER -->
    <div class="page-logo">
        <a href="/api/v1/client/dashboard">
            <img src="../../../assets/admin/layout4/img/Suzi-K-Logo.png" align="middle" alt="logo" height="70" width="70" class="logo-default"/>
        </a>
