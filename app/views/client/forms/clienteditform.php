<div class="aside" tabindex="-1" role="dialog">
    <div class="aside-dialog">
        <div class="aside-content">
            ...
            <div class="aside-body">
                ...
                <form name="frmAppointments" class="form-horizontal" novalidate="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select ng-model="selected_event.haircut_type" class="form-control" id="haircut_type" name="haircut_type" ng-change="getTimes(selected_event.haircut_type,selected_event.date)" placeholder="Haircut Type" value="{{haircut_type}}"
                                    ng-required="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="date" class="form-control" id="date" name="date" placeholder="Date" value="{{date}}"
                                   ng-model="selected_event.date" ng-change="getTimes(selected_event.haircut_type,selected_event.date)" ng-required="true">
                            <span class="help-inline"
                                  ng-show="frmAppointments.date.$invalid && frmAppointments.date.$touched">Date field is required</span>
                        </div>
                    </div>

                    <button type="button" class="btn btn-primary" ng-disabled="frmAppointments.date.$invalid || addEvent.haircut_type.$invalid" ng-click="showTimes = !showTimes">Get Available Times</button>
                    <hr>
            ...
            <tt>times = {{selected_event.time}}</tt><br/>
